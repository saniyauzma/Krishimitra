...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:5173",
        "http://127.0.0.1:8081",
        "https://krishimitra-git-main-saniyauzmas-projects.vercel.app",
        "https://krishimitra-ha4xgyswg-saniyauzmas-projects.vercel.app",
    ],
    allow_origin_regex=r"https?://(localhost|127\.0\.0\.1|0\.0\.0\.0|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.(1[6-9]|2\d|3[0-1])\.\d+\.\d+)(:\d+)?$|https://.*\.vercel\.app$",
